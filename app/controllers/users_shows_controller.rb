...
post '/users/:user_id/shows' do
  ...
  if @show.save
    ...
    if @season.save
     ...
     @episodes_previews = @season.skip != nil ? Show.get_episodes(@season.appleTvId, @season.season, @season.skip, @season.count, @season.storeId) : Show.get_episodes(@season.collectionId, @season.season)
