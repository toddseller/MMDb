class Movie < ActiveRecord::Base
  ...
  def self.basic_info(u)
    movies_list = []
    u.movies.each { |movie| movies_list << {id: movie.id, title: movie.title, sort_name: movie.sort_name, search_name: movie.search_name, poster: movie.poster, year: movie.year} }
    movies_list
  end
